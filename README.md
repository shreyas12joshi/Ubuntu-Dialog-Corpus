...
- Used LDA
- Used NMF
Although since because of time constraints in training, I could not compare the two models. I have tested NMF on single file data as asked in question but I wanted to evaluate on the entire corpus. So, I trained LDA on the entire data set. This is pretty time consuming (with the computational power of my system). The topics generated by LDA are more consistent, although this needs a deeper evaluation.
